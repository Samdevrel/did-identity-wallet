      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Decentralized identity management wallet for managing self-sovereign credentials and verifiable claims.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Create and manage DID identities</li>
            <li>Issue and receive verifiable credentials</li>
            <li>Store claims in portable format</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            ...
            <li>✓ VC issuance and verification</li>
            <li>✓ Credential storage and retrieval</li>
            <li>✓ Privacy-preserving identity proof</li>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Request or issue credentials</li>
            <li>Store verifiable claims</li>
